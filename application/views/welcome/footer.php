                    ...
                    <div class="themeix-footer-bottom">
                        <div class="inner-section">
                            ...
                            <ul class="footer-menu">
                                <li><a href="<?php echo base_url() ?>privacy-policy/index.html">Privacy Policy</a></li>
                                <li><a href="<?php echo base_url() ?>about/index.html">About Us</a></li>
                                <li><a href="<?php echo base_url() ?>disclaimer/index.html">Disclaimer</a></li>
                            </ul>
...
<!-- end scrollUP button -->
<a id="scrollUp" href="#"></a>
<script src="<?php echo base_url() ?>assets/js/pluginsbdd1.js?v=0c0c229e70"></script>
<script src="<?php echo base_url() ?>assets/js/mainbdd1.js?v=0c0c229e70"></script>

</body>

<!-- Mirrored from appix.themeix.com/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 28 Oct 2017 11:19:38 GMT -->
</html>