                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form">
                                <form class="form-validate form-horizontal" id="feedback_form" method="post" action="cat">
                                    <div class="form-group ">
                                        <label for="cname" class="control-label col-lg-2">name </label>
                                        <div class="col-lg-10">
                                            <input class="form-control" id="cname" name="name"  type="text"  />
                                            <span><?php echo form_error('name',"<p class='text-danger'>","</p>");?></span>
                                        </div>
<!--                                    </div>-->
<!--<!--                                    <div class="form-group ">--
<!---->
...
<!--                                                        <div class="col-lg-10">-->
<!--                                                            -->
<!--                                                        <input class="form-control" id="cname" name="date"  type="datetime"  />-->
<!--                                                            <span>--><?php //echo form_error('date',"<p class='text-danger'>","</p>");?><!--</span>-->
<!--                                            </div>-->
...
<!---->
                            ...
                            <div class="form-group ">
                                <div class="col-lg-10">
                                    <input class="btn btn-success" type="submit" name="submit" value="submit" style="margin-left: 180px">
